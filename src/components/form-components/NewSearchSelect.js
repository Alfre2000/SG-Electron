...
import { capitalize, searchOptions } from "../../utils";
...
function NewSearchSelect({ label, name, inputProps, labelProps, labelCols, queryOptions, createTable, initialData, errors, colProps, errorName, showMessageError = true }) {
  const optionsQuery = useCustomQuery({ queryKey: queryOptions });
  ...
  const options = searchOptions(optionsQuery.data, "nome");
  return (
